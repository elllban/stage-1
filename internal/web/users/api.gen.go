...
type ServerInterface interface {
	...
	GetTasksByUserID(ctx echo.Context, userId string) error
}
...
type StrictServerInterface interface {
	...
	// Get tasks for specific user
	// (GET /users/{user_id}/tasks)
	GetTasksByUserID(ctx context.Context, request GetUsersUserIdTasksRequestObject) (GetUsersUserIdTasksResponseObject, error)
}
...
func (sh *strictHandler) GetTasksByUserID(ctx echo.Context, userId string) error {
	var request GetUsersUserIdTasksRequestObject

	request.UserId = userId

	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.GetTasksByUserID(ctx.Request().Context(), request.(GetUsersUserIdTasksRequestObject))
	}
	for _, middleware := range sh.middlewares {
